...
let Header = React.createClass({
  ...
  render() {
    ...
    return <div>{this.appBar(info)}</div>;
  },
  ...
  appBar(info) {
    if (info.icon && info.righticon) {
      ...
      return <AppBar className="header" title={info.name} />;
    }
  },
  ...
  headerPathToTitle(mlocation, params) {
    ...
    if (path === "/list") {
      ...
      return {
        ...
        righticon: (
          <IconButton
            onTouchTap={trigramBtnHandler}
            onClick={trigramBtnHandler}
          >
            <Details />
          </IconButton>
        )
      ...
      return {
        icon: (
          <IconButton
            onTouchTap={this.clearHexagram}
            onClick={this.clearHexagram}
          >
            <BrightnessHigh />
          </IconButton>
        ),
      ...
      return { icon: <IconButton />, name: "I-ching" };
    }
  },
